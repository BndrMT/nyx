...
export default function AIAnalysisModal({ isOpen, onClose, post }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-lg rounded-3xl bg-slate-900 border border-purple-500/30 p-6 shadow-2xl overflow-hidden">
        ...
        {/* STEP 1: Reassuring Intro & Privacy Explanation */}
        {step === "intro" && (
          <div className="mt-4 space-y-4">
            ...
            <div className="p-4 rounded-2xl bg-purple-950/30 border border-purple-800/40 space-y-3">
              ...
              <p className="text-xs text-slate-300 leading-relaxed">
                يتم إجراء هذا التحليل **محلياً بالكامل داخل متصفح جهازك** باستخدام خوارزميات ذكية خفيفة. لا يتم إرسال حرف واحد من كلماتك أو مشاعرك لأي خادم خارجي أو سيرفر إطلاقاً.
              </p>
            </div>

            {/* Reassuring Psychological Disclaimer */}
        ...
        {step === "analyzing" && (
          <div className="py-12 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-sm font-semibold text-slate-200">جارٍ قراءة نبض كلماتك وتحليل طاقة النص محلياً...</p>
            <p className="text-xs text-slate-500 mt-1">يتم معالجة النص داخل جهازك بالكامل بكل أمان</p>
          </div>
        )}

        {/* STEP 3: Tender Reflection Output */}
        {step === "result" && result && (
          <div className="mt-4 space-y-4">
            ...
            {/* Tender Compassionate Reflection */}
            ...
            {/* Optional Coping Whisper Toggle */}
